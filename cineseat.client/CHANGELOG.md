...
- Cree un proyecto de Angular con ng: `ng new cineseat.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`cineseat.client.esproj`).
